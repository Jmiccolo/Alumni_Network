...
exports.signup = async function(req, res, next){
    try{
        ...
        if(!organization.validatedUsers.includes(alumni._id)&&!organization.validatedEmails.includes(alumni.email)){
            organization.attemptedValidation.push({firstName:alumni.firstName, lastName:alumni.lastName, email:alumni.email});
        } else if (!organization.validatedUsers.includes(alumni._id) && organization.validatedEmails.includes(alumni.email)){
            organization.validatedUsers.push(alumni._id);
        }
        organization.save();
...
// Google Auth to be implemented at a later time
